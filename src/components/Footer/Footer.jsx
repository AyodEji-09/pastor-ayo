            ...
            <div className="col-lg-4 col-md-6 footer-links mb-2">
              ...
              <div className="d-flex gap-5">
                <ul>
                  ...
                  <li>
                    <Link className="d-flex align-items-center" href="/contact">
                      <VscDebugBreakpointLogUnverified
                        style={{ marginRight: "4px" }}
                      />{" "}
                      Contact
                  ...
                  <li>
                    <Link className="d-flex align-items-center" href="/booking">
                      <VscDebugBreakpointLogUnverified
                        style={{ marginRight: "4px" }}
                      />{" "}
                      Booking
                ...
                <ul>
                  <li>
                    <Link className="d-flex align-items-center" href="/media">
                      <VscDebugBreakpointLogUnverified
                        style={{ marginRight: "4px" }}
                      />
                      Media
